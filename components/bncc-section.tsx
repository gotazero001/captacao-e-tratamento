...
export function BnccSection() {
  return (
    <section id="bncc" className="bncc-section py-12 sm:py-16 md:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-12 md:mb-16">
          ...
          <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-foreground text-balance px-2 drop-shadow-[0_2px_18px_rgba(103,232,249,0.18)]">
            Competências BNCC
          </h2>
